  ...
  */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        [ ...offcanvasElementList ].map((offcanvasEl => {
            const offcanvasInstance = new Offcanvas(offcanvasEl, {
                backdrop: true,
                scroll: false
            });
        ...
        offcanvasTriggers.forEach((trigger => {
            trigger.addEventListener("click", (function(e) {
                ...
                if (target) {
                    ...
                    const offcanvasInstance = Offcanvas.getInstance(document.querySelector(target)) || new Offcanvas(document.querySelector(target), {
                        backdrop: true
                    });
        ...
        document.querySelectorAll(".offcanvas").forEach((function(offcanvasEl) {
            offcanvasEl.addEventListener("hidden.bs.offcanvas", (function() {
                ...
                if (nextOffcanvas) {
                    ...
                    const nextInstance = Offcanvas.getInstance(document.querySelector(nextOffcanvas)) || new Offcanvas(document.querySelector(nextOffcanvas), {
                        backdrop: true
                    });
                    setTimeout((() => {
                        nextInstance.show();
        ...
        mobileMenuBtns.forEach((btn => {
            btn.addEventListener("click", (function() {
                ...
                if (targetElement) {
                    const offcanvasInstance = Offcanvas.getInstance(targetElement) || new Offcanvas(targetElement, {
                        backdrop: true
                    });
                    offcanvasInstance.show();
                }
